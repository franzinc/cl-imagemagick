...
(defpackage :swig.MagickCore
  (:use :common-lisp :ff :excl)
  (:export #:*swig-identifier-converter* #:*swig-module-name*
           #:*void* #:*swig-export-list*))
(in-package :swig.MagickCore)

(eval-when (:compile-toplevel :load-toplevel :execute)
  (defparameter *swig-identifier-converter* 'identifier-convert-null)
  (defparameter *swig-module-name* :MagickCore))

(defpackage :MagickCore
  (:use :common-lisp :swig.MagickCore :ff :excl))
...
(swig-defconstant "MagickReleaseDate" "2010-07-27")
(swig-defconstant "MagickChangeDate" "20100725")
(swig-defconstant "MagickAuthoritativeURL" "http://www.imagemagick.org")
(swig-defconstant "MagickHomeURL" "file:///usr/local/share/doc/ImageMagick-6.6.3/index.html")
...
(swig-defconstant "MagickVersion" "ImageMagick 6.6.3-2 2010-07-27 Q16 http://www.imagemagick.org")
